    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                <!-- Widget Title -->
                <h6 class="widget-title mb-30">Catagorii</h6>

                <!--  Catagories  trebuie de facut pentru fiecare categorie aparte pagina-->
                <div class="catagories-menu">
                       <ul>
                        <li class="active"><a href="chair.html">Scaune</a></li>
                        <li><a href="beds.html">Dormitoare</a></li>
                        <li><a href="/accesorii">Accesorii</a></li>
                        <li><a href="/furniture">Mobila</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <img src="img/product-img/accesorii1.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="img/product-img/accesorii11.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/product-img/accesorii2.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="img/product-img/accesorii22.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/product-img/accesorii3.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="img/product-img/accesorii33.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/product-img/accesorii4.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="img/product-img/accesorii44.jpg" alt="">   <!-- de schimbat urmatoarea imagine-->
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/product-img/accesorii5.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="img/product-img/accesorii55.jpg" alt="">  <!-- de schimbat urmatoarea imagine -->
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/product-img/accesorii6.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="img/product-img/accesorii66.jpg" alt="">  <!-- de schimbat imaginea urmatoare -->
                            </div>
                    ...
                    <div class="col-12">
                        ...
                        <nav aria-label="navigation">
                            <ul class="pagination justify-content-end mt-50">                <!-- de adaugat mai multe pagini cu mobila exact ca pagina shop -->
                                ...
                                <li class="page-item "><a class="page-link" href="/accesorii">02.</a></li>
                                <li class="page-item "><a class="page-link" href="/accesorii">03.</a></li>
                                <li class="page-item "><a class="page-link" href="/accesorii">04.</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
