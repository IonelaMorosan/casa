...
<head>
    ...
    <!-- Title  -->
    <title>Casa Italiana - Mobila la comanda pentru tine si familia ta! | Checkout</title>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="amado-btn-group mt-30 mb-100">
                <a href="discount.html" class="btn amado-btn mb-15">%Discount%</a>
                <a href="#" class="btn amado-btn active">New this week</a>
            </div>
            <!-- Cart Menu -->
            <div class="cart-fav-search mb-100">
                <a href="favourite.html" class="fav-nav"><img src="img/core-img/favorites.png" alt=""> Favourite<span>(0)</span></a>
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <option value="md">Republica Molodva</option>
                                    ...
                                    <div class="col-12 mb-3">
                                        <textarea name="comment" class="form-control w-100" id="comment" cols="30" rows="10" placeholder="Leave a comment about product ..."></textarea>
                                    </div>
                                       	<div class="cart-btn mt-100">
                                <a href="#" class="btn amado-btn w-100">Send</a>
                                    <!--<div class="col-12">
                                        <div class="custom-control custom-checkbox d-block mb-2">
                                            <input type="button" class="custom-control-input" id="customCheck2">
                                            <label class="custom-control-label" for="customCheck2">Send</label>
                                        </div>
