...
--></div>
		...
		write_logs("view");
			...
			if ($sqlQwer) {
				...
				echo '<tr><th>N/O</th><th>Username</th><th>Statut</th><th>Rol</th><th>Produs</th><th>Cont</th><th>Permisiune</th></tr>';
				while($rows=mysqli_fetch_array($sqlQwer)){
                    ...
                    if ($rows['produs_acces']==1){echo "<td>nepermis</td>";}
                    elseif ($rows['produs_acces']==2) {echo "<td>vizualizare</td>";}
                    elseif ($rows['produs_acces']==3) {echo "<td>editare</td>";}
                    if ($rows['user_acces']==1){echo "<td>nepermis</td>";}
                    elseif ($rows['user_acces']==2) {echo "<td>vizualizare</td>";}
                    elseif ($rows['user_acces']==3) {echo "<td>editare</td>";}
                    if ($rows['roles_acces']==1){echo "<td>nepermis</td>";}
                    elseif ($rows['roles_acces']==2) {echo "<td>vizualizare</td>";}
                    elseif ($rows['roles_acces']==3) {echo "<td>editare</td>";}
