			...
			if ($sqlQwer) {
				...
				while($rows=mysqli_fetch_array($sqlQwer)){
					...
					echo '<td>'.$rows['id_user'].'</td>';
                        ...
                        if ($rows['status']==0) {
                            echo "<td>inactiv</td>";
                            echo "<td><a href=\"unblock.php?id=".$rows['id_user']."\">Unblock</a></td>";
                        }
						else {
                            echo "<td>activ</td>";
                            echo "<td><a href=\"block.php?id=".$rows['id_user']."\">Block</a></td>";
                        }
