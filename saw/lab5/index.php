...
require('log.php');	
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if (!file_exists('connect.php'))
		  throw new Exception ('connect.php does not exist');
		else
		  require('connect.php' ); 
		}
		catch(Exception $e) {    
		    ...
		    FROM user left join rol on user.id_rol =rol.id_rol WHERE username='$login' AND password='$h_pass' AND status=1";
