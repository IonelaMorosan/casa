        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li><a href="shop.html">Cumparaturi</a></li>
                    <li class="active"><a href="product-details.html">Produse</a></li>
                    <!--<li><a href="cart.html">Cart</a></li>
                    <li><a href="checkout.html">Checkout</a></li> -->
                </ul>
            </nav>
            <!-- Button Group -->                                                  <!-- de facut sa functioneze -->
            ...
            <div class="cart-fav-search mb-100">
                <a href="favourite.html" class="cart-nav"><img src="img/core-img/favorites.png" alt=""> Favorite <span>(0)</span></a>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                <li class="breadcrumb-item"><a href="index.html">Acasa</a></li>     <!-- de facut sa functioneze si restul -->
                                <li class="breadcrumb-item"><a href="furniture.html">Mobila</a></li>
                                <li class="breadcrumb-item"><a href="chair.html">Scaune</a></li>
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">   <!-- de schimbat imaginile -->
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(img/product-img/scaun1.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(img/product-img/scaun1.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(img/product-img/scaun11.jpg);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url(img/product-img/scaun1.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="img/product-img/scaun1.jpg">
                                            <img class="d-block w-100" src="img/product-img/scaun1.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/scaun1.jpg">
                                            <img class="d-block w-100" src="img/product-img/scaun1.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/scaun1.jpg">
                                            <img class="d-block w-100" src="img/product-img/scaun11.jpg" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/scaun1.jpg">
                                            <img class="d-block w-100" src="img/product-img/scaun1.jpg" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <div class="ratings-review mb-15 d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="review">
                                        <a href="#">Scrie o recenzie</a>                           <!-- de facut pagina aparte pentru review-->
                                    </div>
                                </div>
                                <!-- Avaiable -->
