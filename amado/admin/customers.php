...
$db = getDbInstance();
$select = array('id', 'listing_name', 'price', 'color', 'category','brand');
...
$customers = $db->arraybuilder()->paginate("listings", $page, $select);
        ...
        <tbody>
            <?php foreach ($customers as $row) : ?>
                <tr>
	                ...
	                <td>
					    <a href="edit_listings.php?listing_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
